...
console.log("category1", fullTreeData )
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed top-0 left-0 h-full w-72 bg-gray-100 p-4 border-r border-gray-200 shadow-md
      ...
      >
        <div className="mb-6">
          ...
          <Link href="/customBazar" onClick={() => setMobileOpen(false)}>
            <Button
              variant="secondary"
              className="text-xl w-full border border-amber-50 md:text-2xl text-gray-800 ps-2"
            >
              Custom Bazar
            </Button>
          </Link>
